...
class ActividadMultiplicacion extends StatefulWidget {
  @override
  _ActividadMultiplicacionState createState() =>
      _ActividadMultiplicacionState();
}

class _ActividadMultiplicacionState extends State<ActividadMultiplicacion> {
  late int numerator1;
  ...
  void _generateFractionProblem() {
    ...
    denominator2 = random.nextInt(5) + 1;
  }
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: "Escribe tu respuesta (Formato: a/b)",
