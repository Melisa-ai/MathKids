...
class FractionSubtractionActivity extends StatefulWidget {
  @override
  _FractionSubtractionActivityState createState() =>
      _FractionSubtractionActivityState();
}

class _FractionSubtractionActivityState
    extends State<FractionSubtractionActivity> {
  late int numerator1;
  ...
  void _generateFractionProblem() {
    final random = Random();
    numerator1 = random.nextInt(5) + 2; // Numeradores del 2 al 6
    denominator1 = random.nextInt(5) + 1; // Denominadores del 1 al 5
    numerator2 = random.nextInt(numerator1 - 1) +
        1; // Numerador menor para evitar negativos
    denominator2 = denominator1; // Mismo denominador para resta simple
  }
